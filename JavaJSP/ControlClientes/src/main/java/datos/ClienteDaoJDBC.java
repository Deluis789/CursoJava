...
public class ClienteDaoJDBC {
    ...
    private static final String SQL_INSERT = "INSERT INTO (nombre,apellido,email,telefono,saldo)"
            + "VALUES(?,?,?,?,?)";
    ...
    public List<Cliente> listar() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                cliente = new Cliente(idCliente, nombre, apellido, email, telefono, sueldo);
    ...
    public int insertar(Cliente cliente) {
        ...
        try {
            ...
            stmt.setDouble(5, cliente.getSueldo());
